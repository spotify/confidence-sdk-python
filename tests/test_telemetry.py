...
class TestTelemetry(unittest.TestCase):
    ...
    def test_multiple_traces(self):
        ...
        self.assertEqual(traces[0].request_trace.status, ProtoStatus.PROTO_STATUS_SUCCESS)
        ...
        self.assertEqual(traces[2].request_trace.status, ProtoStatus.PROTO_STATUS_TIMEOUT)
    ...
    def test_telemetry_during_resolve(self, mock_post):
        ...
        result = confidence.resolve_boolean_details("test-flag", False)
